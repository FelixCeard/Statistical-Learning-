...
\title{Statisitcal Learning and Stochastic Processes \\Sheet 02 }
...
\textbf{Derivation --- Estimated Population Size.}
...
Therefore, we can use Equation~\ref{eq:variance_f_i} to compute the correlation between $f_1$ and $f_2$:
\begin{table}[h]
    \centering
    \begin{tabular}{c|c c c}
        \toprule
